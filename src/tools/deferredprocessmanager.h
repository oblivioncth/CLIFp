...
private:
    ...
    // Log
    static inline const QString LOG_EVENT_PROCCESS_CLOSED = "Deferred process '%1' ( %2 | %3 ) finished. Status: '%4', Code: %5";
    ...
    // Error
    static inline const QString ERR_PROCESS_END_PREMATURE = "Deferred process '%1' ( %2 | %3 ) unexpectedly finished. Status: '%4', Code: %5";
