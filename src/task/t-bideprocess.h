...
private:
    // Meta
    static inline const QString NAME = QStringLiteral("TBideProcess");

    // Logging
    static inline const QString LOG_EVENT_STOPPING_BIDE_PROCESS = "Stopping current bide process...";

    // Errors
    static inline const QString ERR_CANT_CLOSE_BIDE_PROCESS = "Could not automatically end the running title! It will have to be closed manually.";
